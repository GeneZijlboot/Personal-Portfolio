export default function ChangeBg(){
    ...
    if(scrollValue > 1000){
        ...
        Title.innerHTML = `<img id="InitialsImg" src="./Images/ProfileLogoImage/Black-White.png">`;
        ...
        Title.innerHTML = `<img id="InitialsImg" src="./Images/ProfileLogoImage/White-Black.png">`;
        NavBarLinks.innerHTML = `
